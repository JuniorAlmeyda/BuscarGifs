...
export interface SearchGifsRsponse {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsRsponse(json: string): SearchGifsRsponse {
        return cast(JSON.parse(json), r("SearchGifsRsponse"));
    }

    public static searchGifsRsponseToJson(value: SearchGifsRsponse): string {
        return JSON.stringify(uncast(value, r("SearchGifsRsponse")), null, 2);
    }
}
